...
public final class StudentUtils {
    ...
    public static List<Student> xmlToStudentListParse(File inputFile) {
        List<Student> students = new ArrayList<>();
        try {
            Objects.requireNonNull(inputFile, "The inputFile parameter should not be null.");
    ...
    public static boolean listStudentToXml(List<Student> students, File outputFile) {
        try {
